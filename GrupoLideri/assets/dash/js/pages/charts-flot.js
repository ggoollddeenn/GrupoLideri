...
var FlotCharts = function () {
    ...
    return {
        ...
        lineChart : function (chartColours) {
            ...
            //generate random number for chart
            randNum = function(){
            ...
            var options = {
                ...
                colors: [chartColours.blue, chartColours.gray ],
                legend: { 
                    position: "ne", 
                    margin: [0,-25], 
                    noColumns: 0,
        ...
        lineChartDots : function (chartColours) {
            ...
            var options = {
                ...
                colors: [chartColours.red, chartColours.green],
                shadowSize:0,
            ...
            var plot = $.plot($("#line-chart-dots"),
               [{
                ...
                {   
                    label: "Credit Card",
                    data: d2,               
                    points: {fillColor: chartColours.green}
                }], options);
        },

        // Line charts filled
        lineChartFilled : function (chartColours) {
            ...
            var options = {
                ...
                xaxis: {ticks:11, tickDecimals: 0, tickLength: 0},
                colors: [chartColours.gray_light ],
                shadowSize:0,
                tooltip: true, //activate tooltip
                tooltipOpts: {
                    content: "%s : %y.0" + " $",
        ...
        // Auto update chart
        autoUpdateChart : function (chartColours) {
        ...
        // stacked bar charts
        stackedBars : function (chartColours) {
            ...
            var options = {
                ...
                colors: [chartColours.gray, chartColours.gray_lighter ],
                tooltip: true, //activate tooltip
                tooltipOpts: {
                    content: "$%y.0",
                    shifts: {
        ...
        // Ordered bars
        orderedBars : function (chartColours) {
            ...
            var options = {
                    ...
                    colors: [chartColours.gray_light, chartColours.gray, chartColours.green_light],
                    tooltip: true, //activate tooltip
                    tooltipOpts: {
                        content: "%s : %y.0",
                        shifts: {
        ...
        pieChart : function (chartColours) {
            ...
            var data = [
                { label: "Coding",  data: 68, color: chartColours.gray_light},
...
$(document).ready(function() {    
    FlotCharts.lineChart(FlotCharts.chartColours()); //Activate LineChart
    FlotCharts.lineChartDots(FlotCharts.chartColours()); //Activate LineChartDots
    FlotCharts.lineChartFilled(FlotCharts.chartColours()); //Activate LineChartDots
    FlotCharts.autoUpdateChart(FlotCharts.chartColours()); //Activate AutoUpdate chart

    FlotCharts.stackedBars(FlotCharts.chartColours()); //Activate Stacked bars
    FlotCharts.orderedBars(FlotCharts.chartColours()); //Activate Ordered bars

    FlotCharts.pieChart(FlotCharts.chartColours()); //Activate Pie chart
    FlotCharts.donutChart(FlotCharts.chartColours()); //Activate Donut chart
}); 